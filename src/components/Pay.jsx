  ...
  <div class="px-4 pt-8">
    ...
    <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
      ...
      <div class="flex flex-col rounded-lg bg-white sm:flex-row">
        ...
        <div class="flex w-full flex-col px-4 py-4">
          <span class="font-semibold">60GB Data pack </span>
          {/* <span class="float-right text-gray-400">42EU - 8.5US</span> */}
          <p class="mt-auto text-lg font-bold">$50</p>
        </div>
      </div>
    </div>
    ...
    <div className="flex flex-row items-center">
        <img src="src\assets\qr.png" alt="" className="m-6 rounded-[20px]"/>
        <img src="src\assets\razorpay-icon.svg" alt="" className="m-6 rounded-[20px] w-[150px] h-[100px]"/>
    </div>
  </div>
  <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
    ...
    <div class="">
      ...
      <div class="mt-6 border-t border-b py-2">
        ...
        <div class="flex items-center justify-between">
          <p class="text-sm font-medium text-gray-900">Offers</p>
          <p class="font-semibold text-gray-900">- $8.00</p>
        </div>
      </div>
      <div class="mt-6 flex items-center justify-between">
        <p class="text-sm font-medium text-gray-900">Total</p>
        <p class="text-2xl font-semibold text-gray-900">$142.00</p>
      </div>
    </div>
    <button class="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white">Make Payment</button>
  </div>
</div>
